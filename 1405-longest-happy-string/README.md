<h2><a href="https://leetcode.com/problems/longest-happy-string/description/">1405. Longest Happy String</a></h2><h3>Medium</h3><hr><p>A string <code>s</code> is called <strong>happy</strong> if it satisfies the following conditions:</p>
